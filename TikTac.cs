...
namespace MultiplePrograms
{
    class TikTac
    {
        ...
        public static void DrawBoard() // Draw board method ==========================================
        {
        ...
        public static void Play()
        {
            ...
            Console.WriteLine("Hello! This is Tic Tac Toe game.");
            Console.WriteLine("What is the name of player 1?");
            player1 = Console.ReadLine();
            Console.WriteLine("Okay. What is the name of player 2?");
            player2 = Console.ReadLine();
            Console.WriteLine("Okay. {0} is O and {1} is X.", player1, player2);
        ...
        public static bool CheckWin() // Win checker method ================================================
        {
